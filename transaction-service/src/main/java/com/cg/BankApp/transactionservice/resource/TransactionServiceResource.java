...
public class TransactionServiceResource {
	...
	public ResponseEntity<Transaction> deposit(@RequestBody Transaction transaction) {
		...
		ResponseEntity<Double> entity = restTemplate.getForEntity(
				"http://mmbank/Account/accounts/" + transaction.getAccountNumber() + "/balance", Double.class);
		...
		restTemplate.put(
				"http://mmbank/Account/accounts/" + transaction.getAccountNumber() + "?balance=" + updateBalance, null);
	...
	public ResponseEntity<Transaction> fundTransfer(@RequestParam("accountNumber") int sendersAccountNumber,
		...
		ResponseEntity<Double> senderentity = restTemplate
				.getForEntity("http://mmbank/Account/accounts/" + sendersAccountNumber + "/balance", Double.class);
		...
		restTemplate.put("http://mmbank/Account/accounts/" + sendersAccountNumber + "?balance=" + updateBalance, null);
		ResponseEntity<Double> receiverentity = restTemplate
				.getForEntity("http://mmbank/Account/accounts/" + receiversAccountNumber + "/balance", Double.class);
		...
		restTemplate.put("http://mmbank/Account/accounts/" + receiversAccountNumber + "?balance=" + updatedBalance,
				null);
		return new ResponseEntity<>(HttpStatus.CREATED);
	}
