...
public class BankAppController {
	...
	public String deposit(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://mmbank/Transaction-service/transactions/deposit", 
				transaction, null);
	...
	public String withdraw(@ModelAttribute Transaction transaction,
			Model model) {
		restTemplate.postForEntity("http://mmbank/Transaction-service/transactions/withdraw", 
				transaction, null);
		model.addAttribute("message","Success!");
		return "withdraw";
	}
	...
	public ModelAndView getStatement(@RequestParam("offset") int offset, @RequestParam("size") int size) {
		...
		CurrentDataSet currentDataSet = restTemplate.getForObject("http://mmbank/Transaction-service/transactions/statements", CurrentDataSet.class);
